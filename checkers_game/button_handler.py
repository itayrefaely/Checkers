...
class ButtonHandler:
    ...
    def init_in_game_buttons(self):
        ...
        self.in_game_buttons["player_one"] = Button('textures/button_texture.png',
                                                    player_rubric_size,
                                                    (0.5 * self.board_square_size, 0.2 * self.board_square_size),
                                                    "PLAYER 1")
        self.in_game_buttons["player_two"] = Button('textures/button_texture.png',
                                                    player_rubric_size,
        ...
        self.in_game_buttons["player_one_score_keeper"] = Button('textures/button_texture.png',
                                                                 ...
                                                                 "12")
        self.in_game_buttons["player_two_score_keeper"] = Button('textures/button_texture.png',
                                                                 score_keeper_rubric_size,
        ...
        self.in_game_buttons["offer_draw"] = Button('textures/button_texture.png', self.button_size,
                                                    (self.board.pos[0] +
                                                     self.board.width + 0.25 * self.board_square_size,
                                                     self.board.pos[1] + 0.25 * self.board_square_size),
                                                    "OFFER DRAW")
        self.in_game_buttons["resign"] = Button('textures/button_texture.png', self.button_size,
                                                (self.board.pos[0] +
                                                 self.board.width + 0.25 * self.board_square_size,
                                                 self.in_game_buttons["offer_draw"].pos[1] +
                                                 self.board_square_size),
                                                "RESIGN")
        self.in_game_buttons["options"] = Button('textures/button_texture.png', self.button_size,
                                                 (self.board.pos[0] +
                                                  self.board.width + 0.25 * self.board_square_size,
    ...
    def init_general_buttons(self):
        self.general_buttons["rematch"] = Button('textures/button_texture.png', self.general_button_size,
                                                 (self.screen_width // 2 - self.button_size[0] * 1.2,
                                                  self.screen_height // 2 - self.button_size[1] * 0.75),
                                                 "REMATCH")
        self.general_buttons["quit"] = Button('textures/button_texture.png', self.general_button_size,
                                              (self.screen_width // 2 + self.button_size[0] * 0.2,
                                               self.screen_height // 2 - self.button_size[1] * 0.75),
                                              "QUIT")
        self.general_buttons["yes_resign"] = Button('textures/button_texture.png', self.general_button_size,
                                                    (self.general_buttons["rematch"].pos[0],
                                                     self.general_buttons["rematch"].pos[1]),
                                                    "YES")
        self.general_buttons["no_resign"] = Button('textures/button_texture.png', self.general_button_size,
                                                   (self.general_buttons["quit"].pos[0],
                                                    self.general_buttons["quit"].pos[1]),
                                                   "NO")
        self.general_buttons["easy"] = Button('textures/button_texture.png', self.general_button_size,
                                              (self.screen_width // 2 - self.button_size[0] * 1.6,
                                               self.screen_height // 2 - self.button_size[1] * 0.75),
                                              "EASY")
        self.general_buttons["medium"] = Button('textures/button_texture.png', self.general_button_size,
                                                (self.screen_width // 2 - self.button_size[0] * 0.5,
                                                 self.screen_height // 2 - self.button_size[1] * 0.75),
                                                "MEDIUM")
        self.general_buttons["hard"] = Button('textures/button_texture.png', self.general_button_size,
                                              (self.screen_width // 2 + self.button_size[0] * 0.6,
                                               self.screen_height // 2 - self.button_size[1] * 0.75),
                                              "HARD")
        self.general_buttons["change_difficulty"] = Button('textures/button_texture.png', self.general_button_size,
                                                           (self.general_buttons["rematch"].pos[0],
                                                            self.general_buttons["rematch"].pos[1]),
                                                           "CHANGE DIFFICULTY")
        self.general_buttons["game_rules"] = Button('textures/button_texture.png', self.general_button_size,
                                                    (self.general_buttons["quit"].pos[0],
                                                     self.general_buttons["quit"].pos[1]),
                                                    "GAME RULES")
        self.general_buttons["got_it_draw"] = Button('textures/button_texture.png', self.general_button_size,
                                                     (self.general_buttons["medium"].pos[0],
                                                      self.general_buttons["medium"].pos[1]),
                                                     "GOT IT")
        self.general_buttons["got_it_game_rules"] = Button('textures/button_texture.png', self.general_button_size,
                                                           (self.general_buttons["medium"].pos[0],
